...
class ChimeTTSOptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input):
        ...
        self.data = {
            ...
            FALLBACK_TTS_CACHE_KEY: self.get_data_key_value(FALLBACK_TTS_CACHE_KEY, user_input, False),
        ...
        options_schema = vol.Schema(
            {
                ...
                vol.Optional(FALLBACK_TTS_PLATFORM_KEY, default=self.data[FALLBACK_TTS_PLATFORM_KEY]):selector.SelectSelector(
                    selector.SelectSelectorConfig(
                        ...
                        mode=selector.SelectSelectorMode.DROPDOWN,
                        custom_value=True)),
                vol.Optional(FALLBACK_TTS_CACHE_KEY, default=self.data[FALLBACK_TTS_CACHE_KEY]): bool,

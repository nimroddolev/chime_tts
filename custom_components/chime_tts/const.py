...
FALLBACK_TTS_REPORT_NOTIFICATION = "notification"
FALLBACK_TTS_REPORT_REPAIR = "repair"
FALLBACK_TTS_REPORT_DEFAULT = FALLBACK_TTS_REPORT_DEBUG
FALLBACK_TTS_REPORT_OPTIONS = [
    FALLBACK_TTS_REPORT_DEBUG,

...
async def async_update_configuration(config_entry: ConfigEntry, hass: HomeAssistant = None):
    ...
    # Cache fallback TTS Platform audio (off by default: a clip generated by the
    # fallback platform during an outage would otherwise keep being served from
    # cache after the primary platform recovers)

...
The chime path value can be set to a preset chime, a local path to your own custom files or a URL to a remote audio file (see [selecting chimes](./#selecting-chimes)).

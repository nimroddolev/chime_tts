...
Changing the Custom Chimes Folder path, or the folder's file contents will require a restart of Home Assistant before the custom chimes will be available to use.
...
### R.I.P Custom Chime Slots (\<v1.1.0)
:::warning[DEPRECATED: Custom chime slots for the chime list UI]

**Until v1.1.0** users had 5 chime slots to assign their custom chimes for scripts and automations.

**Since v1.1.0** the slots have been deprecated in favour of the [Custom Chimes Folder](#custom-chimes-folder).

Automations and scripts with references to custom slots (eg: `chime_path: custom_chime_path_3`) will continue to work as normal.

...
You can add chimes to your notifications:
...
### 3. Custom chimes folder
You can specify a [local folder path in the configuration](../../configuration#custom_chimes_folder) containing your own chime audio files.

Any change to the folder path or the file contents will require a restart of Home Assistant.

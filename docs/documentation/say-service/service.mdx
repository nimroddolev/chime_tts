...
**Please note** that Chime TTS utilizes [TTS Platforms](https://www.home-assistant.io/integrations/#text-to-speech), and therefore works __with__ these platforms. You need to add them to your Home Assistant instance separately.

...
4. Include any [`chime_tts.say`](/chime_tts/docs/documentation/actions/say-action) [parameters](/chime_tts/docs/documentation/actions/say-action/parameters) and set the default values.

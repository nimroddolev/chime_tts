...
**Convenience**: Configure any/all [`chime_tts.say`](../services/say-service) [parameter](../services/say-service/parameters) values (chime paths, media players, TTS platform, language, voice, etc) once for all your use-cases, and reuse.

**Flexibility**: Retain the ability to override the defined notify settings across your scripts & automations when needed.

**Efficiency**: Replace long complicated [`chime_tts.say`](../services/say-service) service calls with simple, clean and predefined notify service calls.
